...
for i in range(0,10):
    schale[i] = [r, -phi0+i*phi0/5, 0]

for i in range(10,20):
    schale[i] = [r, np.pi-phi0+(i-10)*phi0/5, 0]

for i in range(20,30):
    schale[i] = [r, -phi0+(i-20)*phi0/5+np.pi/2, 0]

for i in range(30,40):
    schale[i] = [r, np.pi-phi0+(i-30)*phi0/5+np.pi/2, 0]
...
plt.savefig("Blatt8_Aufgabe3b_Feline,Hannah.pdf")
